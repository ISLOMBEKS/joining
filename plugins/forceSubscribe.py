      ...
      try:
        ...
        try:
          sent_message = await message.reply_text(
              "👮‍♂️ {} , siz hali kanalga obuna bo'lmagansiz. Iltimos, quyidagi tugma yordamida qoʻshiling va “✅Tekshirish” tugmasini bosing.".format(message.from_user.mention, channel, channel),
        ...
        await client.send_message(chat_id, text=f"❗ **Men bu [kanal]({channel_url}) da admin emasman.**\n__Meni kanalga admin qilishib qaytadan guruhga qo'shing.\n#Guruhni tark etish...__")
        await client.leave_chat(chat_id)
